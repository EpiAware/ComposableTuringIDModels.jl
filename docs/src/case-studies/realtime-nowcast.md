...
naive_chain = sample(
    naive_post, NUTS(0.9), MCMCThreads(), 1000, 2; progress = false)
nothing # hide
```
...
corrected_chain = sample(
    corrected_post, NUTS(0.9), MCMCThreads(), 1000, 2; progress = false)
nothing # hide
```
...
complete_chain = sample(
    complete_post, NUTS(0.9), MCMCThreads(), 1000, 2; progress = false)
